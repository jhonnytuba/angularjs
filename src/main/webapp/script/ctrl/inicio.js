...
app.controller('InicioCtrl', function($scope) {
	$scope.modernBrowsers = [
      	{	icon: '<img src="https://cdn1.iconfinder.com/data/icons/fatcow/32/opera.png" />',	name: "Opera",	maker: "Opera Software",	ticked: false	},
      	...
      	{	icon: '<img  src="https://cdn1.iconfinder.com/data/icons/humano2/32x32/apps/firefox-icon.png" />',	name: "Firefox",	maker: "Mozilla Foundation",	ticked: false	},
